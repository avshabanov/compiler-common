...
package com.alexshabanov.compiler.common;

import com.alexshabanov.compiler.common.naming.HashSymbolTable;
import com.alexshabanov.compiler.common.naming.Symbol;
import com.alexshabanov.compiler.common.naming.SymbolTable;
...
public final class HashSymbolTableTest {
    ...
    @Test
    public void shouldBuildSymbolsFromSequences() {
        ...
        final Symbol sym4 = table.fromSequence("as" +
                (System.currentTimeMillis() == 0L ? "d" : "df")); // cheating compiler to prohibit string inlining
    ...
    @Test
    public void shouldCreateSymbolsFromEmptySequencesAndCharArrays() {
    ...
    @Test
    public void shouldBuildSymbolsInRandomOrder() {
    ...
    @Test
    public void shouldWriteUtfChars() throws Exception {
    ...
    @Test
    public void shouldCompareSymbolsFromDifferentTables() {
    ...
    @Test
    public void shouldFindSymbolByIndex() {
