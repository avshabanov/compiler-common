...
import com.alexshabanov.compiler.common.diagnostics.DefaultDiagnosticsLog;
import com.alexshabanov.compiler.common.diagnostics.DiagnosticsLog;
import com.alexshabanov.compiler.common.diagnostics.formatter.BasicDiagnosticsFormatter;
import com.alexshabanov.compiler.common.source.DefaultSource;
...
import static com.alexshabanov.compiler.common.diagnostics.parameter.Offset.at;
...
public final class DiagnosticLogTest {
    ...
    @Test
    public void shouldPointToFirstSymbol() {
        setSource("asd\ndef asd  987 asd sfg\n\t\tdef");
    ...
    @Test
    public void shouldPointToEightSymbol() {
        setSource("asd\ndef asd  987 asd sfg\n\t\tdef");
    ...
    @Test
    public void shouldPointToSymbolAfterNewline() {
        setSource("asd\ndef asd  987 asd sfg\n\t\tdef");
    ...
    @Test
    public void shouldPointToSecondSymbol() {
        setSource("a\nd ef\nu");
    ...
    @Test
    public void shouldPrintUnspecifiedErrorToStderr() {
