...
import com.alexshabanov.compiler.common.tag.DefaultTagHolder;
import com.alexshabanov.compiler.common.tag.Key;
import com.alexshabanov.compiler.common.tag.TagHolder;
import com.alexshabanov.compiler.common.tag.UnsupportedTagHolder;
...
public final class TagHolderTest {
    ...
    public void shouldUnsupportedTagHolderNotSupportGet() {
        new UnsupportedTagHolder().getTag(KEY1);
    }

    @Test(expected = UnsupportedOperationException.class)
    public void shouldUnsupportedTagHolderNotSupportPut() {
        new UnsupportedTagHolder().putTag(KEY1, 1);
    }

    @Test
    public void shouldDefaultTagHolderSupportGetAndPut() {
